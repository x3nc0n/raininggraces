...
- **2026-05-11T07:45:28-05:00:** Azure provisioning is now defined as subscription-scope Bicep plus manually triggered GitHub Actions OIDC workflows in both repos; SWA deploy tokens still need a post-provision bootstrap into `AZURE_STATIC_WEB_APPS_API_TOKEN` because repository secrets cannot be set with the default workflow token.
